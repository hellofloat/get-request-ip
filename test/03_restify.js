...
test( 'RESTIFY: get ip of basic request', ( t ) => {
...
test( 'RESTIFY: test default headers', ( t ) => {
...
test( 'RESTIFY: test default headers when no headers are allowed', ( t ) => {
    const headerIP = '10.1.1.1';
    const headers = getRequestIP.DEFAULTS.headers;
    let header = null;
...
test( 'RESTIFY: test allowing only custom headers', ( t ) => {
    const headerIP = '10.1.1.1';
    const customHeaders = [
        'x-custom-header-one',
        'x-custom-header-two'
